...
from klarity_integrations import api_client, exceptions
...
# body param
SchemaForRequestBodyApplicationJson = EnrichmentsEstateRecordsRequestBody


request_body_enrichments_estate_records_request_body = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor202ResponseBodyApplicationJson = AcceptedResponseBody
...
class BaseApi(api_client.Api):
    @typing.overload
    def _v1_enrichments_estate_records_post_oapg(
        self,
    ...
    def _v1_enrichments_estate_records_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_enrichments_estate_records_request_body.serialize(body, content_type)
...
class V1EnrichmentsEstateRecordsPost(BaseApi):
    ...
    def v1_enrichments_estate_records_post(
        ...
        return self._v1_enrichments_estate_records_post_oapg(
            body=body,

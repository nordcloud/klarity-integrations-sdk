...
# body param
SchemaForRequestBodyApplicationJson = EstateRecordsRequestBody


request_body_estate_records_request_body = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _v1_estate_records_post_oapg(
        self,
    ...
    def _v1_estate_records_post_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_estate_records_request_body.serialize(body, content_type)
...
class V1EstateRecordsPost(BaseApi):
    ...
    def v1_estate_records_post(
        ...
        return self._v1_estate_records_post_oapg(
            body=body,

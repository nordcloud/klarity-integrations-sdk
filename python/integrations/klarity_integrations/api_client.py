...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.v1_estate_records_delete  # this is an instance of the class Endpoint
        api_instance.v1_estate_records_delete()  # this invokes api_instance.v1_estate_records_delete.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.v1_estate_records_delete.callable or self.callable in this class

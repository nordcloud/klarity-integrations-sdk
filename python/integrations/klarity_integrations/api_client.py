...
from klarity_integrations import rest
from klarity_integrations.configuration import Configuration
from klarity_integrations.exceptions import ApiTypeError, ApiValueError, ApiException
from klarity_integrations.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'klarity-integrations-client/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = KlarityIntegrationsApi()
        api_instance.v1_enrichments_estate_records_post  # this is an instance of the class Endpoint
        api_instance.v1_enrichments_estate_records_post()  # this invokes api_instance.v1_enrichments_estate_records_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.v1_enrichments_estate_records_post.callable or self.callable in this class

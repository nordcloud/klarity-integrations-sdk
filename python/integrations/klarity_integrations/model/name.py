...
class Name(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Friendly name of a resource (id will be used, if not provided)..  # noqa: E501

        Keyword Args:
            value (str): Friendly name of a resource (id will be used, if not provided)..  # noqa: E501

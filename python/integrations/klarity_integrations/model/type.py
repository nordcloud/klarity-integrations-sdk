...
class Type(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Type of a resource (resourceType/extension) can contain just type, eg `jira` or with subtypes separated by \"/\" symbol..  # noqa: E501

        Keyword Args:
            value (str): Type of a resource (resourceType/extension) can contain just type, eg `jira` or with subtypes separated by \"/\" symbol..  # noqa: E501

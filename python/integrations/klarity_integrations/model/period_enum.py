...
class PeriodEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """PeriodEnum - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] (str): Enum type of billing periods available in External Integrations.., must be one of ["current", "previous", "all", ]  # noqa: E501

        Keyword Args:
            value (str): Enum type of billing periods available in External Integrations.., must be one of ["current", "previous", "all", ]  # noqa: E501

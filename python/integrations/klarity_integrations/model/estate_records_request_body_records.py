...
class EstateRecordsRequestBodyRecords(ModelNormal):
    ...
    def _from_openapi_data(cls, id, type, *args, **kwargs):  # noqa: E501
        """EstateRecordsRequestBodyRecords - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            name (str): Friendly name of a resource (id will be used, if not provided).. [optional]  # noqa: E501
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): Metadata contains a JSON object with information about the record. Keys of the object can by any string value, excluding the `tags` key which is reserved for the tags property. If you want to clear the metadata key, you have to provide it directly in an object with a `null` value. Maximum object size is 1MB. . [optional]  # noqa: E501
            tags ({str: (str,)}): Tags are key => value representing tags in Klarity. If you want to clear the tag key, you have to provide it directly in an object with a `null` value. Maximum object size is 1MB. . [optional]  # noqa: E501
            costs (Costs): [optional]  # noqa: E501
        """

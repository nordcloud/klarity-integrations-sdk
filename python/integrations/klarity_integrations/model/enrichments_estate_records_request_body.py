...
def lazy_import():
    ...
    globals()['EnrichmentsEstateRecordsRequestBodyEnrichments'] = EnrichmentsEstateRecordsRequestBodyEnrichments


class EnrichmentsEstateRecordsRequestBody(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'enrichments': ([EnrichmentsEstateRecordsRequestBodyEnrichments],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, enrichments, *args, **kwargs):  # noqa: E501
        """EnrichmentsEstateRecordsRequestBody - a model defined in OpenAPI

        Args:
            enrichments ([EnrichmentsEstateRecordsRequestBodyEnrichments]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, enrichments, *args, **kwargs):  # noqa: E501
        """EnrichmentsEstateRecordsRequestBody - a model defined in OpenAPI

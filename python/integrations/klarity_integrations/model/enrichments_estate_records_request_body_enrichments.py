...
class EnrichmentsEstateRecordsRequestBodyEnrichments(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'record': (EnrichmentRecord,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, record, data, *args, **kwargs):  # noqa: E501
        """EnrichmentsEstateRecordsRequestBodyEnrichments - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, record, data, *args, **kwargs):  # noqa: E501
        """EnrichmentsEstateRecordsRequestBodyEnrichments - a model defined in OpenAPI

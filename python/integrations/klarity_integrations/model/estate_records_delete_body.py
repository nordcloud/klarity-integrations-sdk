...
class EstateRecordsDeleteBody(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'period': (PeriodEnum,),  # noqa: E501
            'records': ([EstateRecordsDeleteBodyRecords],),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, period, records, *args, **kwargs):  # noqa: E501
        """EstateRecordsDeleteBody - a model defined in OpenAPI

        Args:
            period (PeriodEnum):
            records ([EstateRecordsDeleteBodyRecords]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, period, records, *args, **kwargs):  # noqa: E501
        """EstateRecordsDeleteBody - a model defined in OpenAPI

...
class Costs(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, currency, values, *args, **kwargs):  # noqa: E501
        """Costs - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, currency, values, *args, **kwargs):  # noqa: E501
        """Costs - a model defined in OpenAPI

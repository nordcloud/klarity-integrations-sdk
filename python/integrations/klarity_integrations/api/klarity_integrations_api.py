...
class KlarityIntegrationsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.v1_enrichments_estate_records_post_endpoint = _Endpoint(
            settings={
                'response_type': (AcceptedResponseBody,),
                'auth': [
                    'bearerAuth'
                ],
                'endpoint_path': '/v1/enrichments/estateRecords',
                'operation_id': 'v1_enrichments_estate_records_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
                'all': [
                    'enrichments_estate_records_request_body',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'enrichments_estate_records_request_body': 'body',
                },
        ...
        self.v1_estate_records_delete_endpoint = _Endpoint(
            settings={
                'response_type': (AcceptedResponseBody,),
                'auth': [
                    'bearerAuth'
                ...
                'operation_id': 'v1_estate_records_delete',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
                'all': [
                    'estate_records_delete_body',
                ],
                'required': [],
                'nullable': [
                ],
            ...
            root_map={
                ...
                'location_map': {
                    'estate_records_delete_body': 'body',
                },
                'collection_format_map': {
                }
            },
        ...
        self.v1_estate_records_post_endpoint = _Endpoint(
            settings={
                'response_type': (AcceptedResponseBody,),
                'auth': [
                    'bearerAuth'
    ...
    def v1_enrichments_estate_records_post(
        self,
        **kwargs
    ):
        """Enrich Klarity estate records  # noqa: E501

        Enriching works as upsert per integration, meaning new enrichment will be created if there was none for given integration and if enrichment already existed for given integration, it will be replaced by new one. Cost records can not be enriched.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v1_enrichments_estate_records_post(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            enrichments_estate_records_request_body (EnrichmentsEstateRecordsRequestBody): [optional]
        ...
        return self.v1_enrichments_estate_records_post_endpoint.call_with_http_info(**kwargs)

    def v1_estate_records_delete(
        self,
        **kwargs
    ):
        """Delete Klarity estate records  # noqa: E501

        In Klarity, to delete an estate record created from an External Integration, provide: either, nid; or, id, type, and name. Records can be deleted in current, previous or all periods.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v1_estate_records_delete(async_req=True)
        >>> result = thread.get()


        Keyword Args:
            estate_records_delete_body (EstateRecordsDeleteBody): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.v1_estate_records_delete_endpoint.call_with_http_info(**kwargs)

    def v1_estate_records_post(
        self,
        **kwargs
    ):
        """Manage Klarity estate records  # noqa: E501

        In Klarity, create new estate records, or update the metadata, tags, and costs, in existing estate records. You update metadata, tags, and costs by data-upserting: If you provide a value for a given parameter, the relevant field in the estate record is updated. If you provide no value for a parameter, the given field is not updated in the estate record.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_host_index'] = kwargs.get('_host_index')
        return self.v1_estate_records_post_endpoint.call_with_http_info(**kwargs)

...
// APIClient manages communication with the Klarity Integrations API v0.0.4
...
type APIClient struct {
	...
	KlarityIntegrationsApi KlarityIntegrationsApi
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.KlarityIntegrationsApi = (*KlarityIntegrationsApiService)(&c.common)
